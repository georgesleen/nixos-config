...
- `seerr-setup.service` can fail on deploy/boot (starts before Jellyseerr's Node app is ready, "Waiting for Seerr..." times out); `systemctl start seerr-setup` clears it once seerr is up.
