      ...
      checks = forAllSystems (
        ...
        let
          ...
          suites = {
            ...
            known-good-boot = ./modules/features/known-good-boot;
            lazylibrarian-reap = inputs.nixos-pi4 + "/gs-pi4/lazylibrarian-reap";
            ...
            pressure-guard = inputs.nixos-pi4 + "/gs-pi4/pressure-guard";
